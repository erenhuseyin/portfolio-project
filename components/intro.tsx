...
export default function Intro() {
  ...
  const { ref } = useSectionInView("Giriş", 0.5);
    ...
    <section 
        ...
        <div className="flex items-center justify-center">
            <div className='relative'>
                ...
                >
                    <Image
                        src="https://images.unsplash.com/photo-1723748818560-6a942988c7b5?q=80&w=2714&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                        alt="profil"
                        width="192"
                        height="192"
                        quality="95"
      ...
      >
        ...
        <span className="underline">Java (Spring Boot)</span> , mikroservis mimarisi ve {" "}
        <span className="underline">React / Next.js</span> üzerinde uzmanlaşmaya çalıştığım teknolojilerdir.
      </motion.h1>
      ...
      >
        ...
        <a
          ...
          href="https://www.linkedin.com/in/erenhuseyin/"
          target="_blank"
        >
          <BsLinkedin />
        </a>
        ...
        <a
          ...
          href="https://github.com/erenhuseyin"
          target="_blank"
        >
          <FaGithubSquare />
        </a>
